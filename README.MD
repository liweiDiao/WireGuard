### ------2018-12-11  TunSafe 测试已挂，估计被封了--
### TunSafe VPN 一款基于WireGuard 协议的VPN

##### 目前很多反馈安装过程也需要科学的。我给大家一个临时解决方案，我在目录chromeExtensions 下上传了一个1.0.4_0.crx chrome扩展程序，使用chrome安装扩展程序后可实现科学。(2020-02-26)
